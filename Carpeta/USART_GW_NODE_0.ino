...
//defino la configuración de red conforme a los parametros de mi router
uint8_t ip_address[4]  = {192, 168, 2, 13};
uint8_t subnet_mask[4] = {255, 255, 255, 0};
uint8_t ip_gateway[4]  = {192, 168, 2, 10};
...
{   
    ...
    SetAsPeerNode(0xAB02, 1);//0xD001 no es correcto
    SetAsPeerNode(0xD002, 2);
